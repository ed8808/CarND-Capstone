...
class TLClassifier(object):
  ...
  def get_classification(self, image):
	...
	if output_dict['detection_classes'].name == 'traffic_light_green':
		return TrafficLight.GREEN	
	elif output_dict['detection_classes'].name =='traffic_light_red':
		return TrafficLight.RED
	elif output_dict['detection_classes'].name =='traffic_light_yellow':
